...
extension MQTTClientTests {
    ...
    var stubbedConfiguration: IMQTTConfiguration {
        MQTTConfiguration(
            connectRetryTimePolicy: mockConnectRetryTimePolicy, authFailureHandler: mockAuthFailureHandler, eventHandler: mockEventHandler, isMQTTPersistentEnabled: true, isMQTTMemoryPersistentEnabled: false, fixCxxDestructCrash: false, useSafeDeleteForNonSQLiteStore: false, serializeSessionAccess: false)
    }
